...
public class Scrabble {
    ...
    public static int wordScore(String word) {
        ...
        for (int i = 0; i < 26; i++, lettersValueScanner++) {
            char letter = (char) ('a' + i);
            score += ((MyString.countChar(word, letter) * SCRABBLE_LETTER_VALUES[i] * word.length()));
        }
        return score;
    }
    ...
    public static void playGame() {
        ...
        while (true) {
            ...
            if (input.equals("e")) {
                break;
            } else if (!input.equals("n") && !input.equals("e")) {
                System.out.println("Invalid input, enter n or e only");
